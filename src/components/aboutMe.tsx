    ...
    <div className="text-2xl text-white  py-32">
      <MaxWidthWrapper>
        <div className="grid grid-cols-2">
          <div className="w-full bg-red-4 px-20 ">
            <p className="text-6xl font-myNameFont ">
          ...
          <div className="w-full bg-blue- font-myNameFont px-20">
            <p className="text-justify text-[20px] text-gray-300">
