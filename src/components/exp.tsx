            ...
            {ExperienceData.map((experience, index) => (
              ...
              >
                <div className="sticky flex flex-col md:flex-row z-40 items-cente top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                  <div className="h-12 absolute left-3 w-12 rounded-full bg-transparent backdrop-blur-3xl border border-gray-500 flex items-center justify-center shadow-lg">
                    <div
                ...
                <div className="relative pl-18 md:pl-4 w-full">
                  <Card className="bg-transparent backdrop-blur-3xl  border border-gray-500 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          <h4 className="text-xl font-bold text-white mb-2 flex md:items-center gap-2">
                            <Building2 className="h-5 w-5 text-white" />
                            {experience.position}
                          </h4>

                          <div className="flex flex-col sm:flex-row gap-4 text-sm text-white mb-4">
