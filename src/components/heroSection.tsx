  ...
  return (
    <div className="pt-20">
      ...
      <p className="text-white text-4xl md:text-5xl lg:text-8xl font-myMainFont md:text-center ">HI THERE <br /> I'M  <PointerHighlight
          ...
          >
           <span className="bg-gradient-to-l  to-orange-700 from-purple-700  font-semibold text-transparent bg-clip-text">M.REHAN</span>
          </PointerHighlight>  <br /> WEB DEVELOPER</p>
      </div>
      </MaxWidthWrapper>
    </div>
  );
